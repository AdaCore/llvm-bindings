...
package Clang.Fatal_Error_Handler is
  ...
  --  
   ...
   procedure Install_Aborting_Llvm_Fatal_Error_Handler  -- include/clang-c/FatalErrorHandler.h:22
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure Uninstall_Llvm_Fatal_Error_Handler  -- include/clang-c/FatalErrorHandler.h:29
   with Import => True, 
        Convention => C, 
