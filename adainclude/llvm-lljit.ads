...
package LLVM.LLJIT is
  ...
  --  
   ...
   with Convention => C;  -- include/llvm-c/LLJIT.h:56
  ...
  --  
   ...
   type Orc_LLJIT_Builder_T is access all Orc_Opaque_LLJIT_Builder_Impl_T;  -- include/llvm-c/LLJIT.h:62
  ...
  --  
   ...
   type Orc_LLJIT_T is access all Orc_Opaque_LLJIT_Impl_T;  -- include/llvm-c/LLJIT.h:67
  ...
  --  
   ...
   function Orc_Create_LLJIT_Builder return Orc_LLJIT_Builder_T  -- include/llvm-c/LLJIT.h:75
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure Orc_Dispose_LLJIT_Builder (Builder : Orc_LLJIT_Builder_T)  -- include/llvm-c/LLJIT.h:82
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure Orc_LLJIT_Builder_Set_JIT_Target_Machine_Builder (Builder : Orc_LLJIT_Builder_T; JTMB : LLVM.Orc.Orc_JIT_Target_Machine_Builder_T)  -- include/llvm-c/LLJIT.h:93
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure Orc_LLJIT_Builder_Set_Object_Linking_Layer_Creator
     (Builder : Orc_LLJIT_Builder_T;
      ...
      Ctx : System.Address)  -- include/llvm-c/LLJIT.h:99
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function Orc_Create_LLJIT (Result : System.Address; Builder : Orc_LLJIT_Builder_T) return LLVM.Error.Error_T  -- include/llvm-c/LLJIT.h:117
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function Orc_Dispose_LLJIT (J : Orc_LLJIT_T) return LLVM.Error.Error_T  -- include/llvm-c/LLJIT.h:123
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function Orc_LLJIT_Get_Execution_Session (J : Orc_LLJIT_T) return LLVM.Orc.Orc_Execution_Session_T  -- include/llvm-c/LLJIT.h:132
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function Orc_LLJIT_Get_Main_JIT_Dylib (J : Orc_LLJIT_T) return LLVM.Orc.Orc_JIT_Dylib_T  -- include/llvm-c/LLJIT.h:140
   with Import => True, 
        Convention => C, 
...
function Orc_LLJIT_Get_Triple_String
  ...
  --  
   ...
   function Orc_LLJIT_Get_Global_Prefix (J : Orc_LLJIT_T) return char  -- include/llvm-c/LLJIT.h:151
   with Import => True, 
        Convention => C, 
...
function Orc_LLJIT_Mangle_And_Intern
  ...
  --  
   ...
   function Orc_LLJIT_Add_Object_File
     (J : Orc_LLJIT_T;
      ...
      Obj_Buffer : LLVM.Types.Memory_Buffer_T) return LLVM.Error.Error_T  -- include/llvm-c/LLJIT.h:172
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function Orc_LLJIT_Add_Object_File_With_RT
     (J : Orc_LLJIT_T;
      ...
      Obj_Buffer : LLVM.Types.Memory_Buffer_T) return LLVM.Error.Error_T  -- include/llvm-c/LLJIT.h:185
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function Orc_LLJIT_Add_LLVMIR_Module
     (J : Orc_LLJIT_T;
      JD : LLVM.Orc.Orc_JIT_Dylib_T;
      TSM : LLVM.Orc.Orc_Thread_Safe_Module_T) return LLVM.Error.Error_T  -- include/llvm-c/LLJIT.h:197
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function Orc_LLJIT_Add_LLVMIR_Module_With_RT
     (J : Orc_LLJIT_T;
      ...
      TSM : LLVM.Orc.Orc_Thread_Safe_Module_T) return LLVM.Error.Error_T  -- include/llvm-c/LLJIT.h:209
   with Import => True, 
        Convention => C, 
...
function Orc_LLJIT_Lookup
  ...
  --  
   ...
   function Orc_LLJIT_Get_Obj_Linking_Layer (J : Orc_LLJIT_T) return LLVM.Orc.Orc_Object_Layer_T  -- include/llvm-c/LLJIT.h:226
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function Orc_LLJIT_Get_Obj_Transform_Layer (J : Orc_LLJIT_T) return LLVM.Orc.Orc_Object_Transform_Layer_T  -- include/llvm-c/LLJIT.h:232
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function Orc_LLJIT_Get_IR_Transform_Layer (J : Orc_LLJIT_T) return LLVM.Orc.Orc_IR_Transform_Layer_T  -- include/llvm-c/LLJIT.h:238
   with Import => True, 
        Convention => C, 
