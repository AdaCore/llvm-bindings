...
package LLVM.LLJIT is
  ...
  --  
   ...
   with Convention => C;  -- include/llvm-c/LLJIT.h:55
  ...
  --  
   ...
   type Orc_LLJIT_Builder_T is access all Orc_Opaque_LLJIT_Builder_Impl_T;  -- include/llvm-c/LLJIT.h:61
  ...
  --  
   ...
   type Orc_LLJIT_T is access all Orc_Opaque_LLJIT_Impl_T;  -- include/llvm-c/LLJIT.h:66
  ...
  --  
   ...
   function Orc_Create_LLJIT_Builder return Orc_LLJIT_Builder_T  -- include/llvm-c/LLJIT.h:74
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure Orc_Dispose_LLJIT_Builder (Builder : Orc_LLJIT_Builder_T)  -- include/llvm-c/LLJIT.h:81
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure Orc_LLJIT_Builder_Set_JIT_Target_Machine_Builder (Builder : Orc_LLJIT_Builder_T; JTMB : LLVM.Orc.Orc_JIT_Target_Machine_Builder_T)  -- include/llvm-c/LLJIT.h:92
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure Orc_LLJIT_Builder_Set_Object_Linking_Layer_Creator
     (Builder : Orc_LLJIT_Builder_T;
      ...
      Ctx : System.Address)  -- include/llvm-c/LLJIT.h:98
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function Orc_Create_LLJIT (Result : System.Address; Builder : Orc_LLJIT_Builder_T) return LLVM.Error.Error_T  -- include/llvm-c/LLJIT.h:116
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function Orc_Dispose_LLJIT (J : Orc_LLJIT_T) return LLVM.Error.Error_T  -- include/llvm-c/LLJIT.h:122
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function Orc_LLJIT_Get_Execution_Session (J : Orc_LLJIT_T) return LLVM.Orc.Orc_Execution_Session_T  -- include/llvm-c/LLJIT.h:130
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function Orc_LLJIT_Get_Main_JIT_Dylib (J : Orc_LLJIT_T) return LLVM.Orc.Orc_JIT_Dylib_T  -- include/llvm-c/LLJIT.h:138
   with Import => True, 
        Convention => C, 
...
function Orc_LLJIT_Get_Triple_String
  ...
  --  
   ...
   function Orc_LLJIT_Get_Global_Prefix (J : Orc_LLJIT_T) return char  -- include/llvm-c/LLJIT.h:149
   with Import => True, 
        Convention => C, 
...
function Orc_LLJIT_Mangle_And_Intern
  ...
  --  
   ...
   function Orc_LLJIT_Add_Object_File
     (J : Orc_LLJIT_T;
      ...
      Obj_Buffer : LLVM.Types.Memory_Buffer_T) return LLVM.Error.Error_T  -- include/llvm-c/LLJIT.h:170
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function Orc_LLJIT_Add_Object_File_With_RT
     (J : Orc_LLJIT_T;
      ...
      Obj_Buffer : LLVM.Types.Memory_Buffer_T) return LLVM.Error.Error_T  -- include/llvm-c/LLJIT.h:182
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function Orc_LLJIT_Add_LLVMIR_Module
     (J : Orc_LLJIT_T;
      JD : LLVM.Orc.Orc_JIT_Dylib_T;
      TSM : LLVM.Orc.Orc_Thread_Safe_Module_T) return LLVM.Error.Error_T  -- include/llvm-c/LLJIT.h:195
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function Orc_LLJIT_Add_LLVMIR_Module_With_RT
     (J : Orc_LLJIT_T;
      ...
      TSM : LLVM.Orc.Orc_Thread_Safe_Module_T) return LLVM.Error.Error_T  -- include/llvm-c/LLJIT.h:208
   with Import => True, 
        Convention => C, 
...
function Orc_LLJIT_Lookup
  ...
  --  
   ...
   function Orc_LLJIT_Get_Obj_Linking_Layer (J : Orc_LLJIT_T) return LLVM.Orc.Orc_Object_Layer_T  -- include/llvm-c/LLJIT.h:224
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function Orc_LLJIT_Get_Obj_Transform_Layer (J : Orc_LLJIT_T) return LLVM.Orc.Orc_Object_Transform_Layer_T  -- include/llvm-c/LLJIT.h:230
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function Orc_LLJIT_Get_IR_Transform_Layer (J : Orc_LLJIT_T) return LLVM.Orc.Orc_IR_Transform_Layer_T  -- include/llvm-c/LLJIT.h:235
   with Import => True, 
        Convention => C, 
