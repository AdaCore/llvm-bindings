...
package LLVM.Object is
  ...
  -- Opaque type wrappers
   ...
   type Section_Iterator_T is access all Opaque_Section_Iterator_Impl_T;  -- include/llvm-c/Object.h:37

   type Opaque_Symbol_Iterator_Impl_T is null record;   -- incomplete struct

   type Symbol_Iterator_T is access all Opaque_Symbol_Iterator_Impl_T;  -- include/llvm-c/Object.h:38

   type Opaque_Relocation_Iterator_Impl_T is null record;   -- incomplete struct

   type Relocation_Iterator_T is access all Opaque_Relocation_Iterator_Impl_T;  -- include/llvm-c/Object.h:39
  ...
  --*< Offloading fatbinary.  
   type Binary_Type_T is 
     (Binary_Type_Archive,
      ...
      Binary_Type_Wasm,
      Binary_Type_Offload)
   with Convention => C;  -- include/llvm-c/Object.h:59
  ...
  --  
   ...
   function Create_Binary
     (Mem_Buf : LLVM.Types.Memory_Buffer_T;
      ...
      Error_Message : System.Address) return LLVM.Types.Binary_T  -- include/llvm-c/Object.h:77
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure Dispose_Binary (BR : LLVM.Types.Binary_T)  -- include/llvm-c/Object.h:87
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function Binary_Copy_Memory_Buffer (BR : LLVM.Types.Binary_T) return LLVM.Types.Memory_Buffer_T  -- include/llvm-c/Object.h:98
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function Binary_Get_Type (BR : LLVM.Types.Binary_T) return Binary_Type_T  -- include/llvm-c/Object.h:105
   with Import => True, 
        Convention => C, 
...
function Mach_O_Universal_Binary_Copy_Object_For_Arch
  ...
  --  
   ...
   function Object_File_Copy_Section_Iterator (BR : LLVM.Types.Binary_T) return Section_Iterator_T  -- include/llvm-c/Object.h:133
   with Import => True, 
        Convention => C, 
...
function Object_File_Is_Section_Iterator_At_End
  ...
  --  
   ...
   function Object_File_Copy_Symbol_Iterator (BR : LLVM.Types.Binary_T) return Symbol_Iterator_T  -- include/llvm-c/Object.h:155
   with Import => True, 
        Convention => C, 
...
function Object_File_Is_Symbol_Iterator_At_End
   ...
   procedure Dispose_Section_Iterator (SI : Section_Iterator_T)  -- include/llvm-c/Object.h:165
   with Import => True, 
        Convention => C, 
        External_Name => "LLVMDisposeSectionIterator";

   procedure Move_To_Next_Section (SI : Section_Iterator_T)  -- include/llvm-c/Object.h:167
   with Import => True, 
        Convention => C, 
        External_Name => "LLVMMoveToNextSection";

   procedure Move_To_Containing_Section (Sect : Section_Iterator_T; Sym : Symbol_Iterator_T)  -- include/llvm-c/Object.h:168
   with Import => True, 
        Convention => C, 
        External_Name => "LLVMMoveToContainingSection";

  -- ObjectFile Symbol iterators
   procedure Dispose_Symbol_Iterator (SI : Symbol_Iterator_T)  -- include/llvm-c/Object.h:172
   with Import => True, 
        Convention => C, 
        External_Name => "LLVMDisposeSymbolIterator";

   procedure Move_To_Next_Symbol (SI : Symbol_Iterator_T)  -- include/llvm-c/Object.h:173
   with Import => True, 
        Convention => C, 
...
function Get_Section_Name
   ...
   function Get_Section_Size (SI : Section_Iterator_T) return stdint_h.uint64_t  -- include/llvm-c/Object.h:177
   with Import => True, 
        Convention => C, 
...
function Get_Section_Contents
   ...
   function Get_Section_Address (SI : Section_Iterator_T) return stdint_h.uint64_t  -- include/llvm-c/Object.h:179
   with Import => True, 
        Convention => C, 
...
function Get_Section_Contains_Symbol
  ...
  -- Section Relocation iterators
   function Get_Relocations (Section : Section_Iterator_T) return Relocation_Iterator_T  -- include/llvm-c/Object.h:185
   with Import => True, 
        Convention => C, 
        External_Name => "LLVMGetRelocations";

   procedure Dispose_Relocation_Iterator (RI : Relocation_Iterator_T)  -- include/llvm-c/Object.h:186
   with Import => True, 
        Convention => C, 
...
function Is_Relocation_Iterator_At_End
   ...
   procedure Move_To_Next_Relocation (RI : Relocation_Iterator_T)  -- include/llvm-c/Object.h:189
   with Import => True, 
        Convention => C, 
...
function Get_Symbol_Name
   ...
   function Get_Symbol_Address (SI : Symbol_Iterator_T) return stdint_h.uint64_t  -- include/llvm-c/Object.h:193
   with Import => True, 
        Convention => C, 
        External_Name => "LLVMGetSymbolAddress";

   function Get_Symbol_Size (SI : Symbol_Iterator_T) return stdint_h.uint64_t  -- include/llvm-c/Object.h:194
   with Import => True, 
        Convention => C, 
        External_Name => "LLVMGetSymbolSize";

  -- RelocationRef accessors
   function Get_Relocation_Offset (RI : Relocation_Iterator_T) return stdint_h.uint64_t  -- include/llvm-c/Object.h:197
   with Import => True, 
        Convention => C, 
        External_Name => "LLVMGetRelocationOffset";

   function Get_Relocation_Symbol (RI : Relocation_Iterator_T) return Symbol_Iterator_T  -- include/llvm-c/Object.h:199
   with Import => True, 
        Convention => C, 
        External_Name => "LLVMGetRelocationSymbol";

   function Get_Relocation_Type (RI : Relocation_Iterator_T) return stdint_h.uint64_t  -- include/llvm-c/Object.h:200
   with Import => True, 
        Convention => C, 
...
function Get_Relocation_Value_String
  ...
  --* Deprecated: Use LLVMBinaryRef instead.  
   ...
   type Object_File_T is access all Opaque_Object_File_Impl_T;  -- include/llvm-c/Object.h:208

  --* Deprecated: Use LLVMCreateBinary instead.  
   function Create_Object_File (Mem_Buf : LLVM.Types.Memory_Buffer_T) return Object_File_T  -- include/llvm-c/Object.h:211
   with Import => True, 
        Convention => C, 
        External_Name => "LLVMCreateObjectFile";

  --* Deprecated: Use LLVMDisposeBinary instead.  
   procedure Dispose_Object_File (Object_File : Object_File_T)  -- include/llvm-c/Object.h:214
   with Import => True, 
        Convention => C, 
        External_Name => "LLVMDisposeObjectFile";

  --* Deprecated: Use LLVMObjectFileCopySectionIterator instead.  
   function Get_Sections (Object_File : Object_File_T) return Section_Iterator_T  -- include/llvm-c/Object.h:217
   with Import => True, 
        Convention => C, 
...
function Is_Section_Iterator_At_End
  ...
  --* Deprecated: Use LLVMObjectFileCopySymbolIterator instead.  
   function Get_Symbols (Object_File : Object_File_T) return Symbol_Iterator_T  -- include/llvm-c/Object.h:224
   with Import => True, 
        Convention => C, 
