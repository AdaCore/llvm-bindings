...
package LLVM.Analysis is
  ...
  -- verifier will just return 1  
   ...
   with Convention => C;  -- include/llvm-c/Analysis.h:39
...
function Verify_Function
  ...
  --   Useful for debugging.  
   ...
   procedure View_Function_CFG (Fn : LLVM.Types.Value_T)  -- include/llvm-c/Analysis.h:56
   with Import => True, 
        Convention => C, 
        External_Name => "LLVMViewFunctionCFG";

   procedure View_Function_CFG_Only (Fn : LLVM.Types.Value_T)  -- include/llvm-c/Analysis.h:57
   with Import => True, 
        Convention => C, 
